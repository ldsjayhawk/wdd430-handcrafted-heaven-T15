...
export default function ShopPage() {
    ...
    const filtered = useMemo(() => {
        ...
        if (minPrice !== null)
            out = out.filter((p) => p.price >= (minPrice ?? 0));
        if (maxPrice !== null)
            out = out.filter((p) => p.price <= (maxPrice ?? Infinity));
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <p className={styles.sub}>Showing {filtered.length} products</p>
            </div>
            ...
            <div className={styles.controlsRow}>
                    ...
                    <div className={styles.filterBox}>
                        ...
                        <div className={styles.priceRangeRow}>
                            ...
                            <div className={styles.rangeValues}>
                                <span>
                                    ${(minPrice ?? priceBounds.min).toFixed(0)}
                                </span>
                                <span>
                                    ${(maxPrice ?? priceBounds.max).toFixed(0)}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div className={styles.mainCol}>
                    ...
                    <div className={styles.paginationRow}>
                        ...
                        <button
                            onClick={() =>
                                setPage((s) => Math.min(pageCount, s + 1))
                            }
